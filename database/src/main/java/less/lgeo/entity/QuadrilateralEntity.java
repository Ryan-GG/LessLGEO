...
public class QuadrilateralEntity {
  ...
  public static Quadrilateral toGpb(QuadrilateralEntity quadrilateralEntity) {
    return Quadrilateral.newBuilder()
        .setType(LineType.QUADRILATERAL)
        .setColorId(quadrilateralEntity.getColor().getId())
        .setP1(Vector3Embeddable.toGpb(quadrilateralEntity.getP1()))
        .setP2(Vector3Embeddable.toGpb(quadrilateralEntity.getP2()))
        .setP3(Vector3Embeddable.toGpb(quadrilateralEntity.getP3()))
        .setP4(Vector3Embeddable.toGpb(quadrilateralEntity.getP4()))
        .build();
  }
