...
public class QuadrilateralEntity {
  ...
  public static Quadrilateral toGpb(QuadrilateralEntity quadrilateralEntity) {
    return Quadrilateral.newBuilder()
        ...
        .setP1(VertexEmbeddable.toGpb(quadrilateralEntity.getP1()))
        .setP2(VertexEmbeddable.toGpb(quadrilateralEntity.getP2()))
        .setP3(VertexEmbeddable.toGpb(quadrilateralEntity.getP3()))
        .setP4(VertexEmbeddable.toGpb(quadrilateralEntity.getP4()))
        .build();
  }
