...
class BoundBoxTest {
  ...
  void getBoundingBoxSinglePoint() {
    ...
    assertEquals(boundingBox.getMin(),
        new Vector3d(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY));
    assertEquals(boundingBox.getMax(),
        new Vector3d(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY));
  ...
  void getBoundingBoxThreePoints() {
    ...
    assertEquals(toVector3d(min), boundingBox.getMin());
    assertEquals(toVector3d(mid), boundingBox.getCenter());
    assertEquals(toVector3d(max), boundingBox.getMax());
  }
